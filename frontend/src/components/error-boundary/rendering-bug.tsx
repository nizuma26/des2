...
export default function RenderingBug() {

  const { palette } = useTheme();

  const PRIMARY_MAIN = palette.primary

  const titleError = 'Ups ha ocurrido un error inesperado!';
  const contentError = 'Refresque la pagina e intentelo nuevamente.';
  
  return (
    <NotFoundView titleError={titleError} contentError={contentError}>
      <Box
      sx={{
        width: 290,
        height: 290,
    ...
    >
      <svg className="MuiBox-root css-1wsj86v" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id=":r2:" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
            <stop offset="0%" stop-color={PRIMARY_MAIN.main}></stop>
            <stop offset="100%" stop-color={PRIMARY_MAIN.main} stop-opacity="0"></stop>
          </linearGradient>
        </defs>
        <path
          fill="url(#:r2:)"
        ...
        ></path>
        <image
          href="/assets/illustrations/character-8.webp"
          height="300"
          x="340"
          y="30"
        ></image>
        <path
          fill={PRIMARY_MAIN.main}
        ...
        <defs>
          ...
          >
            <stop stop-color={PRIMARY_MAIN.main}></stop>
            <stop offset="1" stop-color={PRIMARY_MAIN.dark}></stop>
          </linearGradient>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color={PRIMARY_MAIN.light}></stop>
            <stop offset="1" stop-color={PRIMARY_MAIN.dark}></stop>
          </linearGradient>
        </defs>
      </svg>
